...
#### R&D 분야는 석사학위를 매우 우대하고 채용하므로 학사 졸업 후 갈 수 있는 생산,설비,기술,품질 업무 위주로 직무조사를 하였습니다.
...
* 팀으로 수행해야 할 것
  + 캡스톤 설계
    * 모듈화된 배터리 팩 설계 or 다양한 환경에서의 배터리 성능평가 or 자율주행차 배터리 관리 시스템  
    * 캡스톤을 해봄으로써, 특정 주제에 대해 깊이 연구하고 실제 실험을 진행하므로써 전문성을 높일 수 있고, 팀 단위 프로젝트이므로 협업 및 의사소통 능력을 향상시킬 수 있다. 또한, 담당 교수님이나 현업 선배와의 멘토링을 통해 실무적 조언을 받을 수 있으며 이러한 구체적이고 실질적인 프로젝트 경험은 취업시장에서의 경쟁력을 향상 시킬 수 있다.  
  + 프로젝트 경험
    * 배터리 성능 테스트 or 전기차 배터리 시스템 설계 or BMS 개발  
    * 프로젝트 경험을 함으로써, 실무경험을 더 쌓을 수 있고, 실질적인 문제를 해결할 수 있는 능력을 키울 수 있다. 또한, 팀 단위 협업을 해봄으로써 협업 및 커뮤니케이션 능력을 향상시킬 수 있다. 또한, 프로젝트를 진행하면서, 최신 기술 및 업계동향을 접할 수 있어, 업계트렌드를 이해하고 현업에서 요구하는 스킬과 지식을 미리 습득할 수 있다.
